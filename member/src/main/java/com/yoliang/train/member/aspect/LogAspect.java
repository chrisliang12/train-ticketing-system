package com.yoliang.train.member.aspect;
...
public class LogAspect {
     ...
     * 定义一个切点
     */
    @Pointcut("execution(public * com.yoliang..*Controller.*(..))")
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        // 打印请求信息
        LOG.info("------------- Begin -------------");
        LOG.info("Reques Addr: {} {}", request.getRequestURL().toString(), request.getMethod());
